...
from .dataset import dataset_subnetwork3
...
class TrainDataLoader(BaseDataLoader):
    def __init__(self, data_dir, batch_size, shuffle, validation_split, num_workers):
        ...
        self.dataset = dataset_subnetwork3.TrainDataset(data_dir, transform=transform)
...
class InferDataLoader(DataLoader):
    def __init__(self, data_dir):
        ...
        self.dataset = dataset_subnetwork3.InferDataset(data_dir, transform=transform)
